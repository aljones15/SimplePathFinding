...
INSTALL="/nix/store/c07gdr6cm43j1cphadzafq185k711vx4-coreutils-8.26/bin/install -c"
...
if test "$form" = normal ; then
	if test "no" = yes ; then
	if test "no" = no ; then
		/nix/store/lpk84rsbha199vm3k54498lqv2jswqj8-bash-4.4-p5/bin/bash $0 format $verb $mandir $srcdir $*
		exit 0
	fi
	fi
...
(*.[0-9]*)
	...
	if test ! -f /home/liminal18/Programs/haskell/PathFinder/ncurses-6.0/man_alias.sed ; then
cat >>/home/liminal18/Programs/haskell/PathFinder/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/liminal18/Programs/haskell/PathFinder/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/liminal18/Programs/haskell/PathFinder/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /home/liminal18/Programs/haskell/PathFinder/ncurses-6.0/man_alias.sed \
		< $i >$TMP
